-- Створення бази даних goit-rdb-hw-03
DROP DATABASE IF EXISTS `goit-rdb-hw-03`;
CREATE DATABASE `goit-rdb-hw-03` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `goit-rdb-hw-03`;
...
-- Готово!
SELECT 'Database goit-rdb-hw-03 created successfully!' AS status;
